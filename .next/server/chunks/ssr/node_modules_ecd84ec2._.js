...
}, ye = ({ exp: e }, t = Date.now())=>!e || e * 1e3 < t, me = ({ sub: e }, t)=>e !== t, Ee = ({ aud: e }, t)=>!e, ge = ({ aud: e }, t)=>e !== t, Me = "en";
function x(e, t = !0) {
    var o, a;
...
}, le = .034, Ut = (e, t, r = le)=>Math.abs(e - t) <= r, ze = (e, t, r = le)=>e > t || Ut(e, t, r), Ht = (e, t = le)=>e.paused && ze(e.currentTime, e.duration, t), Qe = (e, t)=>{
    var u, s, p;
...
var Wt = (e, t)=>{
    ...
    v(t, "encrypted", async (n)=>{
        try {
            ...
            ]).then(([, u])=>u), d = await Bt(c, G(e, "fairplay")).catch((u)=>{
    ...
    var d;
    let { envKey: n, disableTracking: o, muxDataSDK: a = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], muxDataSDKOptions: i = {} } = e, c = tt(e);
    if (!o && (n || c)) {
    ...
    if (v(t, "durationchange", u), t && n) {
        ...
        if (typeof o == "string") {
            if (o.endsWith(".mp4") && o.includes(a)) {
                let R = qe(o), M = new URL(`https://stream.${a}/${R}/metadata.json`);
                de(M.toString(), t);
            }
            let T = ()=>{
        ...
        if (m.muxCode === D.NETWORK_NOT_READY) {
            ...
            if (E < 6) {
                let y = E === 0 ? 5e3 : 6e4, k = new f(`Retrying in ${y / 1e3} seconds...`, m.code, m.fatal);
...
function VideoPlayer(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(3), { playbackId } = t0;
    let t1;
...
//# sourceMappingURL=node_modules_ecd84ec2._.js.map