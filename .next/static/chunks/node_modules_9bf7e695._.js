...
var f = L;
var at = (e)=>e == null, O = (e, t)=>at(t) ? !1 : e in t, K = {
    ANY: "any",
    MUTED: "muted"
}, _ = {
    ON_DEMAND: "on-demand",
...
var F = (e)=>{
    ...
    return it(e);
}, Q = (e)=>e === "VOD" ? _.ON_DEMAND : _.LIVE, Z = (e)=>e === "EVENT" ? Number.POSITIVE_INFINITY : e === "VOD" ? Number.NaN : 0, it = (e)=>{
    let { src: t } = e;
    if (!t) return "";
    let r = "";
    try {
...
function x(e) {
    ...
    var o, a;
    let r = t && (a = (o = Y) == null ? void 0 : o[e]) != null ? a : e, n = t ? Y.code : Me;
    return new z(r, n);
}
var z = class {
    format(t) {
    ...
    constructor(t, r = ((n)=>(n = Y) != null ? n : Me)()){
        this.message = t, this.locale = r;
    }
};
var dt = Object.values(K), xe = (e)=>typeof e == "boolean" || typeof e == "string" && dt.includes(e), Re = (e, t, r)=>{
    let { autoplay: n } = e, o = !1, a = !1, i = xe(n) ? n : !!n, c = ()=>{
        o || v(t, "playing", ()=>{
            o = !0;
        }, {
            once: !0
...
var oe = "cuepoints", Pe = Object.freeze({
    label: oe
});
async function _e(e, t) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Pe;
    return ve(e, t, r.label, "metadata");
}
var $ = (e)=>({
        time: e.startTime,
...
async function he(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Pe;
...
var ae = "chapters", Le = Object.freeze({
    label: ae
}), B = (e)=>({
...
async function Ne(e, t) {
    ...
    return ve(e, t, r.label, "chapters");
}
function ft(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {
        label: ae
...
var se = {
    ...
    var M, h;
    if (a) {
        let b = x("Your device appears to be offline", o), E = void 0, y = f.MEDIA_ERR_NETWORK, k = new f(b, y, !1, E);
    ...
    if (c === 200) return;
    let s = V(t), p = Et(t, r), l = mt(t), [T] = F((M = r.playbackId) != null ? M : "");
    if (!c || !T) return;
    let m = ee(p);
    if (p && !m) {
        let b = x("The {tokenNamePrefix}-token provided is invalid or malformed.", o).format({
            tokenNamePrefix: s
        }), E = x("Compact JWT string: {token}", o).format({
            token: p
        }), y = new f(b, u, !0, E);
        return y.errorCategory = t, y.muxCode = D.NETWORK_TOKEN_MALFORMED, y.data = e, y;
    }
    if (c >= 500) {
        let b = new f("", u, n != null ? n : !0);
        return b.errorCategory = t, b.muxCode = D.NETWORK_UNKNOWN_ERROR, b;
    }
    if (c === 403) if (m) {
        if (ye(m, d)) {
            let b = {
                timeStyle: "medium",
                dateStyle: "medium"
            }, E = x("The video\u2019s secured {tokenNamePrefix}-token has expired.", o).format({
                tokenNamePrefix: s
            }), y = x("Expired at: {expiredDate}. Current time: {currentDate}.", o).format({
                expiredDate: new Intl.DateTimeFormat("en", b).format((h = m.exp) != null ? h : 0 * 1e3),
                currentDate: new Intl.DateTimeFormat("en", b).format(d)
            }), k = new f(E, u, !0, y);
            return k.errorCategory = t, k.muxCode = D.NETWORK_TOKEN_EXPIRED, k.data = e, k;
        }
        if (me(m, T)) {
            let b = x("The video\u2019s playback ID does not match the one encoded in the {tokenNamePrefix}-token.", o).format({
                tokenNamePrefix: s
            }), E = x("Specified playback ID: {playbackId} and the playback ID encoded in the {tokenNamePrefix}-token: {tokenPlaybackId}", o).format({
                tokenNamePrefix: s,
                playbackId: T,
        ...
        if (Ee(m, l)) {
            let b = x("The {tokenNamePrefix}-token is formatted with incorrect information.", o).format({
                tokenNamePrefix: s
            }), E = x("The {tokenNamePrefix}-token has no aud value. aud value should be {expectedAud}.", o).format({
                tokenNamePrefix: s,
                expectedAud: l
            }), y = new f(b, u, !0, E);
        ...
        if (ge(m, l)) {
            let b = x("The {tokenNamePrefix}-token is formatted with incorrect information.", o).format({
                tokenNamePrefix: s
            }), E = x("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.", o).format({
                tokenNamePrefix: s,
                expectedAud: l,
                aud: m.aud
            }), y = new f(b, u, !0, E);
        ...
        let b = x("Authorization error trying to access this {category} URL. If this is a signed URL, you might need to provide a {tokenNamePrefix}-token.", o).format({
            tokenNamePrefix: s,
            category: t
        }), E = x("Specified playback ID: {playbackId}", o).format({
            playbackId: T
        }), y = new f(b, u, n != null ? n : !0, E);
        return y.errorCategory = t, y.muxCode = D.NETWORK_TOKEN_MISSING, y.data = e, y;
    }
    if (c === 412) {
        let b = x("This playback-id may belong to a live stream that is not currently active or an asset that is not ready.", o), E = x("Specified playback ID: {playbackId}", o).format({
            playbackId: T
        }), y = new f(b, u, n != null ? n : !0, E);
    ...
    if (c === 404) {
        let b = x("This URL or playback-id does not exist. You may have used an Asset ID or an ID from a different resource.", o), E = x("Specified playback ID: {playbackId}", o).format({
            playbackId: T
        }), y = new f(b, u, n != null ? n : !0, E);
        return y.errorCategory = t, y.muxCode = D.NETWORK_NOT_FOUND, y.data = e, y;
    }
    if (c === 400) {
        let b = x("The URL or playback-id was invalid. You may have used an invalid value as a playback-id."), E = x("Specified playback ID: {playbackId}", o).format({
            playbackId: T
        }), y = new f(b, u, n != null ? n : !0, E);
...
var Se = g.DefaultConfig.capLevelController, j = class j extends Se {
    get levels() {
        var t;
    ...
    getMaxLevel(t) {
        ...
        return o >= a ? r : Se.getMaxLevelByMediaSize(n, a * (16 / 9), a);
    }
    constructor(t){
        super(t);
    }
...
var Dt = (e)=>{
    ...
    var d, u, s, p;
    let { streamType: n, targetLiveWindow: o, liveEdgeStartOffset: a, sessionData: i } = await Ct(e, r), c = i == null ? void 0 : i["com.apple.hls.chapters"];
    ...
    var c, d, u, s, p, l, T, m;
    let { streamType: n, targetLiveWindow: o, liveEdgeStartOffset: a, lowLatency: i } = Pt(e);
    if (n === _.LIVE) {
...
}, He, Ve, kt = (Ve = (He = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : He.userAgent) != null ? Ve : "", Ke, We, Ye, ht = (Ye = (We = (Ke = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : Ke.userAgentData) == null ? void 0 : We.platform) != null ? Ye : "", Fe, $e, Be, Lt = (Be = ($e = (Fe = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : Fe.userAgentData) == null ? void 0 : $e.brands) != null ? Be : [], Nt = kt.toLowerCase().includes("android") || [
    "x11",
    "android"
].some((e)=>ht.toLowerCase().includes(e)), Oe = Lt.find((e)=>e.brand === "Google Chrome"), It = (e)=>{
    var t;
    return Oe && parseInt((t = Oe.version) != null ? t : "0") >= 141 && !!e.canPlayType("application/vnd.apple.mpegurl");
}, P = new WeakMap, A = "mux.com", je, Je, Ge = (Je = (je = g).isSupported) == null ? void 0 : Je.call(je), At = (e)=>Nt || It(e), Gr = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].utils.now(), St = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].utils.generateUUID, qr = function() {
    let { playbackId: e, customDomain: t = A, maxResolution: r, minResolution: n, renditionOrder: o, programStartTime: a, programEndTime: i, assetStartTime: c, assetEndTime: d, playbackToken: u, tokens: { playback: s = u } = {}, extraSourceParams: p = {} } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (!e) return;
    ...
    var t, r, n;
    return (t = e == null ? void 0 : e.metadata) != null && t.video_id ? e.metadata.video_id : tt(e) && (n = (r = q(e.playbackId)) != null ? r : qe(e.src)) != null ? n : e.src;
}, Ot = (e)=>{
    var t;
    ...
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : le;
    return e.paused && ze(e.currentTime, e.duration, t);
}, Qe = (e, t)=>{
    var u, s, p;
    ...
    return a > i && a < c;
}, Vt = (e, t)=>e.ended || e.loop ? e.ended : t && Qe(e, t) ? !0 : Ht(e), Zr = (e, t, r)=>{
    Kt(t, r, e);
    let { metadata: n = {} } = e, { view_session_id: o = St() } = n, a = wt(e);
...
function Ze(e, t) {
    ...
    let o = !r || ((u = t.canPlayType(r)) != null ? u : !0), { preferPlayback: a } = e, i = a === X.MSE, c = a === X.NATIVE, d = Ge && (i || At(t));
    return o && (c || !d);
}
var Wt = (e, t)=>{
    let { debug: r, streamType: n, startTime: o = -1, metadata: a, preferCmcd: i, _hlsConfig: c = {} } = e, u = U(e) === I.M3U8, s = Ze(e, t);
    if (u && !s && Ge) {
        let p = {
            backBufferLength: 30,
        ...
        } : void 0, R = c.capLevelToPlayerSize == null ? {
            ...
            xhrSetup: (h, b)=>{
                ...
                let y = ((pe = (k = E.searchParams.get("CMCD")) == null ? void 0 : k.split(",")) != null ? pe : []).filter((fe)=>fe.startsWith("sid") || fe.startsWith("cid")).join(",");
                E.searchParams.set("CMCD", y), h.open("GET", E);
            },
            ...R,
            ...p,
            ...l,
        ...
        return M.on(g.Events.MANIFEST_PARSED, async function(h, b) {
            var y, k;
            let E = (y = b.sessionData) == null ? void 0 : y["com.apple.hls.chapters"];
            (E != null && E.URI || E != null && E.VALUE.toLocaleLowerCase().startsWith("http")) && de((k = E == null ? void 0 : E.URI) != null ? k : E == null ? void 0 : E.VALUE, t);
        }), M;
    }
}, Yt = (e)=>e === _.LIVE ? {
        backBufferLength: 8
    } : {}, Ft = (e)=>{
    let { tokens: { drm: t } = {}, playbackId: r, drmTypeCb: n } = e, o = q(r);
    return !t || !o ? {} : {
        emeEnabled: !0,
        drmSystems: {
            "com.apple.fps": {
    ...
    v(t, "encrypted", async (n)=>{
        try {
            ...
            if (!t.mediaKeys) {
                ...
                try {
                    let p = await $t(et(e, "fairplay")).catch((l)=>{
            ...
            let c = await Promise.all([
                ...
                let [, u] = param;
                return u;
            }), d = await Bt(c, G(e, "fairplay")).catch((u)=>{
    ...
    var d;
    let { envKey: n, disableTracking: o, muxDataSDK: a = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], muxDataSDKOptions: i = {} } = e, c = tt(e);
    if (!o && (n || c)) {
    ...
    var s, p;
    let n = Ze(e, t), { src: o, customDomain: a = A } = e, i = ()=>{
        t.ended || e.disablePseudoEnded || !Vt(t, r) || (Qe(t, r) ? t.currentTime = t.buffered.end(t.buffered.length - 1) : t.dispatchEvent(new Event("ended")));
    }, c, d, u = ()=>{
        let l = Xe(t), T, m;
    ...
    if (v(t, "durationchange", u), t && n) {
        ...
        if (typeof o == "string") {
            if (o.endsWith(".mp4") && o.includes(a)) {
                let R = qe(o), M = new URL("https://stream.".concat(a, "/").concat(R, "/metadata.json"));
                de(M.toString(), t);
            }
            let T = ()=>{
                if (Ue(t) !== _.LIVE || Number.isFinite(t.duration)) return;
            ...
            }, m = async ()=>vt(o, t, l).then(T).catch((R)=>{
            ...
            (s = e.tokens) != null && s.drm ? jt(e, t) : v(t, "encrypted", ()=>{
                ...
                once: !0
            }), t.setAttribute("src", o), e.startTime && (((p = P.get(t)) != null ? p : {}).startTime = e.startTime, t.addEventListener("durationchange", rt, {
                once: !0
            }));
        } else t.removeAttribute("src");
        t.addEventListener("error", nt), t.addEventListener("error", ce), t.addEventListener("emptied", ()=>{
            ...
            t.ended || ze(t.currentTime, t.duration) && (t.currentTime = t.seekable.length ? t.seekable.start(0) : 0);
        });
    } else r && o ? (r.once(g.Events.LEVEL_LOADED, (l, T)=>{
        _t(T.details, t, r), u(), Ue(t) === _.LIVE && !Number.isFinite(t.duration) && (r.on(g.Events.LEVEL_UPDATED, u), v(t, "durationchange", ()=>{
        ...
        if (m.muxCode === D.NETWORK_NOT_READY) {
            let b = (R = P.get(t)) != null ? R : {}, E = (M = b.retryCount) != null ? M : 0;
            if (E < 6) {
                let y = E === 0 ? 5e3 : 6e4, k = new f("Retrying in ".concat(y / 1e3, " seconds..."), m.code, m.fatal);
                Object.assign(k, m), N(t, k), setTimeout(()=>{
                    b.retryCount = E + 1, T.details === "manifestLoadError" && T.url && r.loadSource(T.url);
                }, y);
                return;
            } else {
                b.retryCount = 0;
    ...
    }), t.addEventListener("error", ce), v(t, "waiting", i), De(e, r), Ce(t, r), r.attachMedia(t)) : console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.");
};
function rt(e) {
    var n;
    let t = e.target, r = (n = P.get(t)) == null ? void 0 : n.startTime;
    if (r && Te(t.seekable, t.duration, r)) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sanity/node_modules/react-compiler-runtime/dist/index.js [app-client] (ecmascript)");
...
function VideoPlayer(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(3), { playbackId } = t0;
    let t1;
...
//# sourceMappingURL=node_modules_9bf7e695._.js.map