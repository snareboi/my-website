...
class EditContextManager {
    ...
    constructor(view){
        ...
        this.handlers.textupdate = (e)=>{
            ...
            if (change.from < change.to && !change.insert.length && view.inputState.composing >= 0 && !RegExp("[\\\\p{Alphabetic}\\\\p{Number}_]").test(context.text.slice(Math.max(0, e.updateRangeStart - 1), Math.min(context.text.length, e.updateRangeStart + 1)))) this.handlers.compositionend(e);
        };
            ...
            for (let format of e.getTextFormats()){
                ...
                if (!/none/i.test(lineStyle) && !/none/i.test(thickness)) {
                    ...
                    if (from < to) {
                        ...
                        let style = "text-decoration: underline ".concat(/^[a-z]/.test(lineStyle) ? lineStyle + " " : lineStyle == "Dashed" ? "dashed " : lineStyle == "Squiggle" ? "wavy " : "").concat(/thin/i.test(thickness) ? 1 : 2, "px");
